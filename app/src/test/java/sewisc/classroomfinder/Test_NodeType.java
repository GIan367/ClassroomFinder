...
public class Test_NodeType {
    ...
    public void testGetType() {
        Node testNode1 = new Node(NodeType.normal, 1000, 5000, 1, "Lids");
        Node testNode2 = new Node(NodeType.stair, 7, 6657, 1, "Stair 2");
        Node testNode3 = new Node(NodeType.elevator, 1223, 4352, 1, "Elevator 22");
